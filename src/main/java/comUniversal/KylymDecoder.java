...
public class KylymDecoder {
    ...
    private int toNumber(int[] number) {
        int result = 10; // '*'
        if (Arrays.equals(number, N0)) {
            result = 0;
        } else if (Arrays.equals(number, N1)) {
            result = 1;
        } else if (Arrays.equals(number, N2)) {
            result = 2;
        } else if (Arrays.equals(number, N3)) {
            result = 3;
        } else if (Arrays.equals(number, N4)) {
            result = 4;
        } else if (Arrays.equals(number, N5)) {
            result = 5;
        } else if (Arrays.equals(number, N6)) {
            result = 6;
        } else if (Arrays.equals(number, N7)) {
            result = 7;
        } else if (Arrays.equals(number, N8)) {
            result = 8;
        } else if (Arrays.equals(number, N9)) {
            result = 9;
        }
        return result;
    }
