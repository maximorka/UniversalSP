...
//    private Button sendButton;
    ...
    public void initialize() {
        ...
        ObservableList <String> mode = FXCollections.observableArrayList("²ðêóò","5×Ò20");
        modeRxComboBox.setItems(mode);
        modeRxComboBox.setValue("Âèáåð³òü");
        ObservableList <String> speedTx = FXCollections.observableArrayList("100","250");
        speedTxComboBox.setItems(speedTx);
        speedTxComboBox.setValue("Âèáåð³òü");

        ObservableList <String> timeTx = FXCollections.observableArrayList("3 õâ","6 õâ","12 õâ");
        timeTxComboBox.setItems(timeTx);

        ObservableList <String> serviceMessageTx = FXCollections.observableArrayList("Ïîâòîð³òü","Çà÷åêàéòå","Äîäàòêîâèé ñåàíñ");
...
//        messageReceived.setEditable(false);
        ...
        serviceMessageTxList.setOnMouseClicked(new EventHandler<MouseEvent>() {
            ...
            public void handle(MouseEvent event) {
                ...
                if(serviceMessage.equals("Äîäàòêîâèé ñåàíñ")){
